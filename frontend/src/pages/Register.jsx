    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 mt-15">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="mt-6 text-4xl font-bold text-white">Create Account</h1>
            ...
            <div className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className={`peer w-full pl-12 pr-4 py-4 bg-gray-900/50 border ${errors.name ? "border-red-500" : "border-gray-700"} rounded-xl text-white placeholder-transparent focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all duration-300`}
            ...
            <div className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className={`peer w-full pl-12 pr-14 py-4 bg-gray-900/50 border ${errors.confirmPassword ? "border-red-500" : "border-gray-700"} rounded-xl text-white placeholder-transparent focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all duration-300`}
